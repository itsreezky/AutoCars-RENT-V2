        ...
        <div class="col-xxl-3 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <b class="fw-bold btn btn-falcon-info me-1 mb-1">
                        <i class="fa-solid fa-list-check me-1"></i>
                        Data Verification Pending </b>
                    <hr>
                    <center>

                        <a href="{{route('administrator.owners-pending') }}">
                            <button class="btn btn-falcon-default btn-sm mb-3">
                                <span class="fa-solid fa-file-excel"></span>
                                <span class="d-md-inline-block ms-1">Check Data Owners Pending</span></button></a>
                    </center>
                    <div class="alert alert-outline-info d-flex align-items-center" role="alert">
                        <span class="fas fa-info-circle text-info fs-5 me-3"></span>
                        <p class="mb-0 flex-1"><b>INFORMASI</b> <br>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img class="img-fluid d-dark-none" src="{{asset ('assets/img/reezky/ReezkyLogoNoBG.png') }}" alt="reezky"
                            >
                        <img class="img-fluid d-light-none" src="{{asset ('assets/img/reezky/ReezkyLogoNoBGWhite.png') }}"
                            alt="reezky">
                        ...
                        <div class="d-grid">
                            ...
                            <a class="btn btn-sm btn-outline-danger mt-3" href="{{route ('administrator.out') }}">Sign Out</a>
                        </div>
                    </div>
                </div>
            </div>
