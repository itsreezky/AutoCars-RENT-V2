                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="d-flex">
                        ...
                        <form action="{{route('addWishlist')}}" method="POST">
                            ...
                            <input type="hidden" name="foto_mobil" id="foto_mobil" value="{{ $cars->foto_mobil }}">
                    ...
                    <a href="/rent/{{ $cars->kode_mobil }}">
                        <button class="btn btn-lg btn-warning rounded-pill w-100 fs-9 fs-sm-8 mt-3">
                            <span class="fa-solid fa-car-on me-2"></span>RENT, NOW !</button></a>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="d-flex flex-column justify-content-between h-100">
                        ...
                        <div class="d-flex flex-wrap align-items-start mb-3">#{{ $cars->kode_mobil }} -
                            <span class="badge text-bg-success fs-9 rounded-pill ms-2 fw-semibold"> {{ $cars->status
                                }}</span>
                        </div>

                        <div class="d-flex flex-wrap align-items-center">
                            <h1 class="me-3">@currency($cars->tarif) / <small>24 hours</small></h1>
                            <p class="text-warning fw-bolder fs-7 mb-0"><span class="badge text-bg-warning">10%
                                    off</span></p>
                        </div>
            ...
            <div class="row gx-3 gy-7">
                <div class="col-12 col-lg-7 col-xl-8">
                    <div class="tab-content" id="productTabContent">
                        <div class="tab-pane pe-lg-6 pe-xl-12 fade show active" id="tab-specification" role="tabpanel"
                            ...
                            <div class="row align-items-center g-5 mb-3 text-center text-sm-start">
                                <div class="col-12 col-sm-auto mb-sm-2">
                                    <div class="avatar avatar-4xl">
                                        <img class="rounded-circle" src="../{{ $own->foto_profile }}" alt="" />
                                    </div>
                                </div>
